...
✅ **Tests automatizados**: `pnpm test` (vitest) — **1333 pruebas en 62 archivos**
al cierre de la ronda de saneo de SVG/PDF, Biopsias y Usuarios (baseline
anterior: **1232 en 58**, cierre de la ronda de Logos y Page Builder). Las que necesitan base real se activan con
