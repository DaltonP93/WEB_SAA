...
/**
 * Extrae el id del recurso de la URL: el segmento numérico que sigue a
 * `resourceType` (`/admin/doctors/42` → "42"). Devuelve `null` si no hay id
 * (alta sobre la colección) o si no es numérico.
 */
